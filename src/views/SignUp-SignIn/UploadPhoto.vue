    ...
    <div class="overflow-auto">
        <div class="userphoto position-relative">
            ...
            <div class="d-flex justify-content-center">
                <the-card 
                    style="width: 340px;" 
                    :class="{active : selectedPhoto == false}" 
                    class="user-card position-absolute pointer-event"
                ></the-card>
            </div>
            ...
            <b-row class="d-flex justify-content-between mt-2">
                <div class="flex-nowrap text-center w-100 d-flex justify-content-between">
                    <b-col md="6" class="ml-2 z-index-101">
                        <a 
                            @click="setMainPhoto = !setMainPhoto" 
                            href="#" 
                    ...
                    <b-col 
                        md="3" 
                        class="ml-5 z-index-101"
                    >
                        <a 
                            href="#" 
                            @click="setMainPhoto = false" 
                            class="text-decoration-none text-dark"
                        >
                            <div v-if="setMainPhoto">
                                Удалить
                            </div>
                            <div 
                                v-else 
                                class="text-warning text-nowrap deleteNotMess position-relative"
                            >
                ...
                <b-link 
                    type="file" 
                    class="text-decoration-none w-100 my-2 z-index-101 px-4" 
                    @click="selectedPhoto =! selectedPhoto"
                >
                    <the-button
                        block
